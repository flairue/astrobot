...
def phase(message):
    if len(message.split()) == 1:
        ...
        i, p = message.split()[1], message.split()[2]
    return 'https://www.timeanddate.com/scripts/moon.php?i={0}.8&p={1}'.format(i, p)

'''
# Adapted from moon.py by Kevin Turner, which was made back in 2001
# and was based on John Walker's code (www.fourmilab.ch)
